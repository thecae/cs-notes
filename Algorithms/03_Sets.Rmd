...
*Set-builder notation* specifies that the set includes all elements in a larger set that also saitisfy serctain conditions.  The notation looks like $A = \{x \in S : P(x)\}$.  $A$ takes elements from $S$ that satisfy condition $P(x)$.
